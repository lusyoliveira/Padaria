...
Public Class frmProdutos
    ...
    Private Sub frmProdutos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ClasseProdutos.ConsultaProduto(lstProduto, txtCodigo.Text, txtProduto.Text)
    End Sub
    Private Sub btnSalvar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSalvar.Click
        ...
        If MsgResult = DialogResult.Yes Then
            ClasseProdutos.AlterarProduto(txtCodigo.Text, txtProduto.Text, txtValidade.Text, txtValorUnit.Text)
            ClasseProdutos.ConsultaProduto(lstProduto, txtCodigo.Text, txtProduto.Text)
            Limpar()
        Else
            Exit Sub
    ...
    Private Sub btnExcluir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExcluir.Click
        ...
        If MsgResult = DialogResult.Yes Then
            ClasseProdutos.ExcluirProduto(txtCodigo.Text)
            ClasseProdutos.ConsultaProduto(lstProduto, txtCodigo.Text, txtProduto.Text)
            Limpar()
        Else
            Exit Sub
    ...
    Private Sub btnAlterar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAlterar.Click
        ...
        If MsgResult = DialogResult.Yes Then
            ClasseProdutos.SalvarProduto(txtCodigo.Text, txtProduto.Text, txtValidade.Text, txtValorUnit.Text)
            ClasseProdutos.ConsultaProduto(lstProduto, txtCodigo.Text, txtProduto.Text)
            Limpar()
        Else
            Exit Sub
